    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.TipoFacturas", t => t.TipoFacturaId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Ventas", "TipoFacturaId", "dbo.TipoFacturas");
            ...
            DropForeignKey("dbo.PuntosDeVenta", "SesionId", "dbo.Sesions");
            DropForeignKey("dbo.Sesions", "User_UserName", "dbo.Users");
            ...
            DropIndex("dbo.Sesions", new[] { "User_UserName" });
